...
public class WeatherController extends AppCompatActivity {
    ...
    final String apiID = "a919b257c7351ca9172e548dd6acf34c";
    final String WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather";
    // App ID to use OpenWeather data
    final String APP_ID = "a919b257c7351ca9172e548dd6acf34c";
    ...
    protected void onResume() {
        ...
        String city = mIntent.getStringExtra("NewCity");

        if(city !=null){
            getWeatherForNewCity(city);
        }
        else{
            Log.d("Clima", "Getting weather for the current location");
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d("Clima", "lattitude is :" +lattitude);
